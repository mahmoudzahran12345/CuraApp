                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      TextButton(onPressed: (){
                                        ...
                                        'Forget Password?',style: TextStyle(color: pramcolor),
                                      )),
                                    ],
                                  ),
                                  ...
                                  TextButton(onPressed: (){
                                    ...
                                    'Dont have an acount:Create' ,style: TextStyle(color: pramcolor),
                                  )),
                                  ConditionalBuilder(
                                        ...
                                        CuraLoginCubit.get(context).googleSignIn();
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              CustomText(title: 'Sign in with google',color: Colors.white,alignment: Alignment.center,
                                                fontSize: 20,
